...
admin_user = User.create(first_name: "유찬", last_name: "서", email: "admin@wingstar.net", password: "123123", locale: "ko", gender: "M" )
admin_user.add_role :admin
admin_ability = Ability.new(admin_user)
admin_ability.can(:manage, Post)

user01 = User.create(first_name: "길동", last_name: "홍", email: "gildong@wingstar.net", password: "123123", locale: "ko", gender: "M" )
user01.add_role :user
Post.create(title: "오늘의 명언", content: "\"고통이 고통이라는 이유로 그 자체를 사랑하고 소유하려는 자는 없다\"", user_id: user01.id, created_at: Time.now)



user02 = User.create(first_name: "Carroll", last_name: "Alison", email: "carroll@wingstar.net", password: "123123", locale: "en", gender: "F" )
user02.add_role :user
